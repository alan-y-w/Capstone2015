...
proc init_gui { IPINST } {
	...
	set C_M_AXI_START_DATA_VALUE [ipgui::add_param $IPINST -parent $Page0 -name C_M_AXI_START_DATA_VALUE]
	set_property tooltip {The master will start generating data from the C_M_START_DATA_VALUE value} $C_M_AXI_START_DATA_VALUE
	set C_M_AXI_TARGET_SLAVE_BASE_ADDR [ipgui::add_param $IPINST -parent $Page0 -name C_M_AXI_TARGET_SLAVE_BASE_ADDR]
	...
	set C_M_AXI_TRANSACTIONS_NUM [ipgui::add_param $IPINST -parent $Page0 -name C_M_AXI_TRANSACTIONS_NUM]
