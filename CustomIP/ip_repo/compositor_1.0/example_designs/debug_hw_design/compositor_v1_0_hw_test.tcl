# Runtime Tcl commands to interact with - compositor_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/compositor_v1_0_include.tcl
...
if { $DE == 10 } {
	...
	puts "Data comparison test fail for - M_AXI, rdata-$rdata_tmp expected-10 actual-$DE"
	inc ec
}
